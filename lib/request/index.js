...
var RequestManager = /** @class */ (function () {
    ...
    RequestManager.prototype.wrapRequest = function (req, promise, opts) {
        ...
        return wxp
            ...
            var code = Number((res && res.statusCode) || 0);
            if (code >= 200 && code < 300) {
                ...
                var error = new Error(res.data && res.data.message ? res.data.message : res.errMsg);
                error.res = res;
                throw error;
            }
        })
...
var ChainableRequest = /** @class */ (function (_super) {
    ...
    ChainableRequest.prototype.exposeFull = function (enable) {
        if (enable === void 0) { enable = true; }
        if (this instanceof Request) {
            var shadow = new ShadowRequest(this._requestManager, __assign({}, this._config));
...
var ShadowRequest = /** @class */ (function (_super) {
    ...
    ShadowRequest.prototype.PUT = function (url, data) {
        return this.request({
            url: url,
            data: data,
            method: 'PUT'
    ...
    ShadowRequest.prototype.DELETE = function (url, params) {
        return this.request({
            url: addUrlQuery(url, pureAssign({}, params)),
            method: 'DELETE'
        }, this._reqOpts);
